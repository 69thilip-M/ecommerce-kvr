    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 mb-8">
        <p className="text-lg text-gray-700 leading-relaxed mb-4">
          Welcome to <span className="font-semibold text-green-700">FreshMart</span> – your one-stop shop for fresh vegetables, fruits, and organic products. 
          We are committed to delivering the best quality products directly from farms to your doorstep.  
        </p>
        <p className="text-lg text-gray-700 leading-relaxed mb-4">
          Founded in 2024, our mission is to make healthy and organic living accessible to everyone. 
          With a wide range of fresh produce, we ensure that your family enjoys the goodness of nature every day.  
        </p>
      ...
      <div className="mb-8">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <li className="bg-green-50 p-4 rounded-xl shadow">
            <h3 className="text-xl font-bold">Thilip Kumar</h3>
            <p className="text-gray-600">Founder & CEO</p>
          </li>
          <li className="bg-green-50 p-4 rounded-xl shadow">
            <h3 className="text-xl font-bold">Anita Sharma</h3>
